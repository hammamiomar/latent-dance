"""Auto-configuration from ComponentClassification for SAE steering.
...
if TYPE_CHECKING:
    from .classification import ComponentClassification
...
def get_base_stem(link_target: str) -> str | None:
    ...
    back to their physical stem ("drums", "bass"). Returns None
    for derived targets that have no single base stem.
    """
